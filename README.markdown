...
This directory contains source files for the Siksika language morphology
...
-   <https://giellalt.uit.no/lang/bla/BlackfootDocumentation.html>
    (analyser)
...
The Siksika language sources can be acquired using [giella SVN
